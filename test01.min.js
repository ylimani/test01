...
! function(t, e) {
    ...
    function la() {
        (v = L()) && (y = v.parseEase, T = v.utils.toArray, b = v.utils.getUnit, V = v.core.getCache, j = v.utils.clamp, A = v.core.getStyleSaver, E = v.core.reverting || function() {}, w = y("power3"), k = w(.05), F = v.core.PropTween, v.config({
            resistance: 100,
            unitFactors: {
                time: 1e3,
                totalTime: 1e3,
